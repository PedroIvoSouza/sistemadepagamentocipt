...
const CRON_ENABLED = (process.env.COMPROVANTE_CRON_ENABLED || '').toLowerCase() === 'true';

if (!CRON_ENABLED) {
  console.log(`[CRON][COMPROVANTES] COMPROVANTE_CRON_ENABLED não está ativo. Cron "gerarComprovantesPagos" não será iniciado.`);
